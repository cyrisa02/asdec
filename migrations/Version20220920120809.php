 ...
 */
final class Version20220920120809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE newsletter (id INT AUTO_INCREMENT NOT NULL, categories_id INT NOT NULL, name VARCHAR(190) NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_sent TINYINT(1) NOT NULL, INDEX IDX_7E8585C8A21214B7 (categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE newsletter ADD CONSTRAINT FK_7E8585C8A21214B7 FOREIGN KEY (categories_id) REFERENCES category (id)');
    }
