 ...
 */
final class Version20220917132531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE presence_timecard (presence_id INT NOT NULL, timecard_id INT NOT NULL, INDEX IDX_775A9699F328FFC4 (presence_id), INDEX IDX_775A9699EA093255 (timecard_id), PRIMARY KEY(presence_id, timecard_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
