 ...
 */
final class Version20220919134736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE timecard DROP is_present, DROP sports_id, DROP sport_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE timecard ADD is_present TINYINT(1) DEFAULT NULL, ADD sports_id INT NOT NULL, ADD sport_id INT NOT NULL');
    }
}
