 ...
 */
final class Version20220919133052 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE timecard_sport (timecard_id INT NOT NULL, sport_id INT NOT NULL, INDEX IDX_FD5BB4D1AC78BCF8 (sport_id), INDEX IDX_FD5BB4D1EA093255 (timecard_id), PRIMARY KEY(timecard_id, sport_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
